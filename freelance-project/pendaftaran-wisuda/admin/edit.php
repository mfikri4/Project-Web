...
if(!isset($_SESSION['id']))
 ...
 mysqli_query($koneksi,"UPDATE wisuda SET nama='$nama',nim='$nim', ttl='$ttl', jenis_kelamin='$jenis_kelamin', alamat='$alamat', telepon='$telepon',
 email='$email', ayah='$ayah',ibu='$ibu',fakultas='$fakultas',jurusan='$jurusan',ipk='$ipk',tanggal_lulus='$tanggal_lulus',judul_skripsi='$judul_skripsi',
 lama_studi='$lama_studi', dosbing='$dosbing',status='$status' WHERE id='$id'");
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <p>
                                ...
                                © 2014 <strong>Titin Ariska Sibarani</strong>
                            </p>
                        </div>
                        <div class="col-sm-6">
