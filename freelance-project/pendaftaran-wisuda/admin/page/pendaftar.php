...
<div class='row' id='home-content'>
    <div class='col-lg-12'>
        ...
        <center>
            <h3 style="color: red">Tabel Pendaftaran<span class='fa fa-user'></span></h3>
        </center>
        <?php
       ...
       ?>
            <tr>
                ...
                <td>
                    <a class="btn-sm btn-primary" href="validasi.php?id=<?php echo $r['id'];  ?>">Validasi</a>
                    <a class="btn-sm btn-danger" href="tolak.php?id=<?php echo $r['id']; ?>">Tolak</a>
                </td>
